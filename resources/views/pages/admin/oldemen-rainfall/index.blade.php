    ...
    <div class="col-md-8">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Klasifikasi Oldeman Curah Hujan</h6>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <button class="btn btn-primary show-form" data-url="{{ url('admin/prediction-rainfall') }}"><i class="fa fa-calculator"></i> Hitung Prediksi</button>
                    <button class="btn btn-danger show-form" data-url="{{ url('admin/delete-prediction-rainfall') }}"><i class="fa fa-trash"></i> Hapus Prediksi</button>
                    <br><br>
